...
@GenerateMocks(
  ...
  customMocks: [
    ...
    MockSpec<ResendService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
  ],
)
...
MockPrefsServiceService getAndRegisterPrefsServiceService() {
  _removeRegistrationIfExists<PrefsServiceService>();
  final service = MockPrefsServiceService();
  locator.registerSingleton<PrefsServiceService>(service);
  return service;
}

MockThemetoggleService getAndRegisterThemetoggleService() {
...
MockResendService getAndRegisterResendService() {
  _removeRegistrationIfExists<ResendService>();
  final service = MockResendService();
  locator.registerSingleton<ResendService>(service);
  return service;
}
// @stacked-mock-create
